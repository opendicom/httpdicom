...
-(void)appendRequestCDATitle:(NSString*)title
{
     ...
     */
    [self appendFormat:@"<code code=\"55115-0\" codeSystem=\"2.16.840.1.113883.6.1\" codeSystemName=\"LOINC\" fullname=\"Solicitud de estudio imagenologico\"/><title>%@</title>", title];
}

-(void)appendReportCDATitle:(NSString*)title
{
    [self appendFormat:@"<code code=\"18748-4\" codeSystem=\"2.16.840.1.113883.6.1\" codeSystemName=\"LOINC\" fullname=\"Solicitud de Diagnóstico imagenologico\"/><title>%@</title>", title];
}
...
{
    [self appendString:@"<confidentialityCode code=\"N\" codeSystem=\"2.16.840.1.113883.5.25\" codeSystemName=\"HL7\" fullname=\"normal\"/>"];
}
                          ...
                          birthdate:(NSString*)birthdate
{
    ...
    if ([sex isEqualToString:@"M"])
        sexString=@"<administrativeGenderCode fullname=\"Masculino\" codeSystem=\"2.16.858.2.10000675.69600\" code=\"1\"></administrativeGenderCode>";
    else if ([sex isEqualToString:@"F"])
        sexString=@"<administrativeGenderCode fullname=\"Femenino\" codeSystem=\"2.16.858.2.10000675.69600\" code=\"2\"></administrativeGenderCode>";
    else
        sexString=@"<administrativeGenderCode fullname=\"otro\" codeSystem=\"2.16.858.2.10000675.69600\" code=\"9\"></administrativeGenderCode>";
...
{
   [self appendFormat:@"<documentationOf><serviceEvent><code=\"%@\" codeSystem=\"%@\" codeSystemName=\"%@\" codeSystemVersion=\"%@\" fullname=\"%@\"><originalText>%@</originalText></documentationOf>",
    procedure[0],
    (K.schemeindexes[@"oid"])[procedure[2]],
    (K.schemeindexes[@"shortname"])[procedure[2]],
    (K.schemeindexes[@"version"])[procedure[2]],
    procedure[1],
...
{
    [self appendFormat:@"<componentOf><encompassingEncounter classCode=\"ENC\"><code code=\"%@\" codeSystem=\"2.16.840.1.113883.6.96\" codeSystemName=\"SNOMED CT\" fullname=\"%@\"/><effectiveTime xsi:type=\"IVL_TS\"><low value=\"%@\"/><high value=\"%@\"/></effectiveTime><location typeCode=\"LOC\"><healthCareFacility classCode=\"SDLOC\"><code code=\"%@\" codeSystem=\"2.16.840.1.113883.6.96\" codeSystemName=\"SNOMED CT\" fullname=\"%@\"/></healthCareFacility></location></encompassingEncounter></componentOf>",
     snomedCode,
     snomedDisplay,
     lowDA,
     highDA,
