...
#pragma mark plist init
   ...
   for (NSString *P in patientKeySet)
   {
      ...
      NSMutableDictionary *patient=[NSMutableDictionary dictionaryWithObjectsAndKeys:
...
#pragma mark study loop
         while (Eindex != NSNotFound)
         {
            ...
            NSMutableDictionary *study=[NSMutableDictionary dictionaryWithObjectsAndKeys:
