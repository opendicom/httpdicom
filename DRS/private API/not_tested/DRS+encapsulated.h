...
//pass as default boundaryString: [[NSUUID UUID]UUIDString]
//when boundaryString is not emnpty, prepares a body for request POST
...
/*
-(NSMutableData*)createCDADICMxmlDataWithCS:(NSString*)CS
                                         DA:(NSString*)DA
                                         TM:(NSString*)TM
                                         TZ:(NSString*)TZ
                                         AN:(NSString*)AN
...
/*
-(NSMutableData*)createCDADICMjsonDataWithCS:(NSString*)CS
                                          DA:(NSString*)DA
                                          TM:(NSString*)TM
                                          TZ:(NSString*)TZ
                                          AN:(NSString*)AN
...
// /{modality}/{objectType}?
// {modality} is one of OT (request or other documents) or DOC (report)
// {objectType} is one of xml, cda, scd, dscd, pdf
